 ...
 * and ring_health_eval's line-formatting callback. */
...
/* node_mgr_cfg.c: cache init/clear, the 1 Hz reconciliation/retry driver,
 * the CFG_CHUNK feed (pull assembler) and the tracker completion hook for
 * RING_T_CFG_GET / RING_T_CFG_COMMIT. */
